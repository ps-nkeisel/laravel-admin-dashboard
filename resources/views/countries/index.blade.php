    ...
    <div class="bg-body-light">
        <div class="content content-full">
            <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
                <h1 class="flex-sm-fill font-size-h2 font-w400 mt-2 mb-0 mb-sm-2">Countries</h1>
    ...
    <div class="content content-full">
        ...
        <div class="block block-rounded block-bordered dynamic_container">
            ...
            <div class="block-content block-content-full">
                ...
                <table id="countries_datatable" class="table table-bordered table-striped table-vcenter">
                    <thead>
                    <tr>
                        <th>ID</th>
                        <th>Sprache</th>
...
@section('js_after')
    ...
    <script>
        $(document).ready(function() {
            var countries_datatable = $('#countries_datatable').DataTable( {
                serverSide: true,
                processing: true,
                searching: true,
                ajax: {
                ...
                columns: [
                    { data: 'id', className: "text-center", width: "80px",
                        render: function(data, type, full, meta) {
                            return '<a href="{{ route("countries.index")}}/' + data + '">' + data + '</a>';
                        }
                    },
                    { data: 'code', className: "font-w600" },
                    { data: 'name', className: "d-none d-sm-table-cell", width: "30%" },
                    { data: 'name_en', className: "d-none d-sm-table-cell", width: "15%" },
                    { data: 'id', className: "text-right", width: "15%", orderable: false,
                        render: function(data, type, full, meta) {
                            return '<a href="{{ route("countries.index")}}/' + data + '/edit" class="btn btn-sm btn-info mr-1" title="Edit Country"><i class="si si-pencil"></i></a>' +
                                '<a href="{{ route("countries.index")}}/' + data + '" class="btn btn-sm btn-primary" title="Show Country"><i class="si si-doc"></i></a>';
                        }
                    },
                ],
            });
