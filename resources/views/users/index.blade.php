    ...
    <div class="content content-full">
        ...
        <div class="block block-rounded block-bordered dynamic_container">
            <div class="block-header block-header-default">
                ...
                <div class="btn-group btn-group-sm pull-right" role="group">
                    <div class="block-options pl-3 pr-2">
                        <a href="{{ route('users.create') }}" class="btn-block-option" title="Create New User">
            ...
            <div class="block-content block-content-full">
                ...
                <table id="users_datatable" class="table table-bordered table-striped table-vcenter">
                    <thead>
                        <tr>
                            <th>ID</th>
                            <th>Name</th>
                ...
                columns: [
                    { data: 'id', className: "text-center", width: "80px",
                        render: function(data, type, full, meta) {
                            return '<a href="{{ route("users.index")}}/' + data + '">' + data + '</a>';
                        }
                    },
                    { data: 'email', className: "d-none d-sm-table-cell", width: "30%" },
                    { data: 'name', className: "d-none d-sm-table-cell", width: "20%" },
                    { data: 'username', className: "d-none d-sm-table-cell", width: "30%" },
                    { data: 'active', className: "d-none d-sm-table-cell", width: "50px",
                        render: function(data, type, full, meta) {
                    ...
                    { data: 'id', className: "text-right", width: "15%", orderable: false,
                        render: function(data, type, full, meta) {
                            return '<a href="{{ route("users.index")}}/' + data + '/edit" class="btn btn-sm btn-info"title="Edit User" style="margin-right:5px;"><i class="si si-pencil"></i></a>' +
                                '<a href="{{ route("users.index")}}/' + data + '" class="btn btn-sm btn-primary" title="Show User"><i class="si si-doc"></i></a>';
                        }
                    },
                ],
            });
