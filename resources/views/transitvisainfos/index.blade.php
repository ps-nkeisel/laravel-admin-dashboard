    ...
    <div class="bg-body-light">
        <div class="content content-full">
            <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
                <h1 class="flex-sm-fill font-size-h2 font-w400 mt-2 mb-0 mb-sm-2">Transitvisa Infos</h1>
    ...
    <div class="content content-full">
        ...
        <div class="block block-rounded block-bordered dynamic_container">
            <div class="block-header block-header-default">
                ...
                <div class="btn-group btn-group-sm pull-right" role="group">
                    <div class="block-options pl-3 pr-2">
                        <a href="{{ route('transitvisainfos.create') }}" class="btn-block-option" title="Create New Transitvisa Info">
            ...
            <div class="block-content block-content-full">
                ...
                <table id="transitvisainfos_datatable" class="table table-bordered table-striped table-vcenter">
                    <thead>
                        <tr>
                            <th>ID</th>
                            <th>Content</th>
...
@section('js_after')
    ...
    <script>
        $(document).ready(function() {
            var transitvisainfos_datatable = $('#transitvisainfos_datatable').DataTable( {
                serverSide: true,
                processing: true,
                searching: true,
                ajax: {
                    url: "{{ route('api.transitvisainfos.search') }}",
                    type: "POST",
                    headers: {
                ...
                columns: [
                    { data: 'id', className: "text-center", width: "80px",
                        render: function(data, type, full, meta) {
                            return '<a href="{{ route("transitvisainfos.index")}}/' + data + '">' + data + '</a>';
                        }
                    },
                    ...
                    { data: 'id', className: "text-right", width: "15%", orderable: false,
                        render: function(data, type, full, meta) {
                            return '<a href="{{ route("transitvisainfos.index")}}/' + data + '/edit" class="btn btn-sm btn-info"title="Edit Transitvisa Info" style="margin-right:5px;"><i class="si si-pencil"></i></a>' +
                                '<a href="{{ route("transitvisainfos.index")}}/' + data + '" class="btn btn-sm btn-primary" title="Show Transitvisa Info"><i class="si si-doc"></i></a>';
                        }
                    },
                ],
            });
