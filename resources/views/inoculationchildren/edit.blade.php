...
@section('content')
    ...
    <div class="bg-body-light">
        <div class="content content-full">
            <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
                <h1 class="flex-sm-fill font-size-h2 font-w400 mt-2 mb-0 mb-sm-2">{{ !empty($title) ? $title : 'Inoculationchild' }}</h1>
    ...
    <!-- card -->
    <div class="content content-full">
        <form method="POST" action="{{ route('inoculationchildren.update', $inoculationchild->id) }}" id="edit_inoculationchild_form" name="edit_inoculationchild_form" accept-charset="UTF-8" class="form-horizontal">
            {{ csrf_field() }}
            ...
            <div class="block block-rounded block-bordered">
                <div class="block-header block-header-default">
                    ...
                    <div class="btn-group btn-group-sm pull-right" role="group">
                        <div class="block-options pl-3 pr-2">
                            <a href="{{ route('inoculationchildren.index') }}" title="Show All Inoculationchild" class="btn-block-option">
                ...
                <div class="block-content">
                    <div class="row justify-content-left py-sm-3 py-md-5" style="padding-top: 1rem !important;">
                        @include ('inoculationchildren.form', [
                                        'inoculationchild' => $inoculationchild,
                                      ])
                    </div>
                </div>
