...
@section('content')
    ...
    <!-- card -->
    <div class="content content-full">
        <form method="POST" action="{{ route('translations.update', $translation->id) }}" accept-charset="UTF-8" id="edit_translation_form" name="edit_translation_form" accept-charset="UTF-8" class="form-horizontal">
            {{ csrf_field() }}
