...
@section('content')
    ...
    <div class="bg-body-light">
        <div class="content content-full">
            <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
                <h1 class="flex-sm-fill font-size-h2 font-w400 mt-2 mb-0 mb-sm-2">Tag create</h1>
    ...
    <!-- card -->
    <div class="content content-full">
        <form method="POST" action="{{ route('adrheadtags.store') }}" accept-charset="UTF-8" id="create_adrheadtag_form" name="create_adrheadtag_form" class="form-horizontal">
            {{ csrf_field() }}
                ...
                <div class="block-header block-header-default">
                    ...
                    <div class="btn-group btn-group-sm pull-right" role="group">
                        <div class="block-options pl-3 pr-2">
                            <a href="{{ route('adrheadtags.index') }}" class="btn-block-option">
