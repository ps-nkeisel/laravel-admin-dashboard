    ...
    <div class="bg-body-light">
        <div class="content content-full">
            <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
                <h1 class="flex-sm-fill font-size-h2 font-w400 mt-2 mb-0 mb-sm-2">TUI Cruises - List all</h1>
    ...
    <div class="content">
        <div class="block block-rounded block-bordered">
            ...
            <div class="block-content">
                <form method="POST" enctype="multipart/form-data" id="form_cruisetuic_search">
                    <div class="row">
                        <div class="col-6">
        ...
        <div class="block block-rounded block-bordered dynamic_container">
            <div class="block-header block-header-default">
                ...
                <div class="btn-group btn-group-sm pull-right" role="group">
                    <div class="block-options pl-3 pr-2">
                        <!--
                        <a href="{{ route('cruisetuics.sync') }}" class="btn-block-option" title="Sync TUI Cruises">
                            <span class="si si-energy" aria-hidden="true"></span>
                        </a>-->
                        <a href="{{ route('cruisetuics.create') }}" class="btn-block-option" title="Create New Record">
...
@section('js_after')
    ...
    <script>
        $(document).ready(function() {
            var cruisetuics_datatable = $('#cruisetuics_datatable').DataTable( {
                ...
                ajax: {
                    ...
                    data: function ( d ) {
                        ...
                        var formData = $('#form_cruisetuic_search').serializeArray();
                ...
                columns: [
                    { data: 'id', className: "text-center", width: "100px",
                        render: function(data, type, full, meta) {
                            return '<a href="{{ route("cruisetuics.index")}}/' + data + '">' + data + '</a>';
                        }
                    },
                    { data: 'countrytocode', className: "d-none d-sm-table-cell" },
            ...
            $('#form_cruisetuic_search').submit(function() {
                cruisetuics_datatable.ajax.reload();
                return false;
            });
            $('#form_cruisetuic_search').on('reset', function () {
