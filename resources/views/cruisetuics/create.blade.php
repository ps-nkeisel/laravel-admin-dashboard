...
@section('content')
    ...
    <div class="bg-body-light">
        <div class="content content-full">
            <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
                <h1 class="flex-sm-fill font-size-h2 font-w400 mt-2 mb-0 mb-sm-2">Cruisetuic create</h1>
                <nav class="flex-sm-00-auto ml-sm-3" aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item">TUI Cruise</li>
    ...
    <!-- card -->
    <div class="content content-full">
        <form method="POST" action="{{ route('cruisetuics.store') }}" accept-charset="UTF-8" id="create_cruisetuic_form" name="create_cruisetuic_form" class="cruisetuic-form form-horizontal">
            {{ csrf_field() }}
                ...
                <div class="block-header block-header-default">
                    ...
                    <div class="btn-group btn-group-sm pull-right" role="group">
                        <div class="block-options pl-3 pr-2">
                            ...
                            <a href="{{ route('cruisetuics.index') }}" class="btn-block-option">
