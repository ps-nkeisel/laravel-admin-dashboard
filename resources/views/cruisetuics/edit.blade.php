...
@section('content')
    ...
    <div class="bg-body-light">
        <div class="content content-full">
            <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
                <h1 class="flex-sm-fill font-size-h2 font-w400 mt-2 mb-0 mb-sm-2">Cruisetuic edit</h1>
    ...
    <!-- card -->
    <div class="content content-full">
        <form method="POST" action="{{ route('cruisetuics.update', $cruisetuic->id) }}" id="edit_cruisetuic_form" name="edit_cruisetuic_form" accept-charset="UTF-8" class="cruisetuic-form form-horizontal">
            {{ csrf_field() }}
            ...
            <div class="block block-rounded block-bordered">
                ...
                <div class="block-content">
                    <div class="row justify-content-left py-sm-3 py-md-5" style="padding-top: 1rem !important;">
                        @include ('cruisetuics.form', [
                                        'cruisetuic' => $cruisetuic,
                                      ])
                    </div>
                </div>
