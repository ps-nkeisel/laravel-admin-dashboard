...
@section('content')
    ...
    <div class="bg-body-light">
        <div class="content content-full">
            <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
                <h1 class="flex-sm-fill font-size-h2 font-w400 mt-2 mb-0 mb-sm-2">Health recommendation edit</h1>
    ...
    <!-- card -->
    <div class="content content-full">
        <form method="POST" action="{{ route('inoculations.update', $inoculation->id) }}" id="edit_inoculation_form" name="edit_inoculation_form" accept-charset="UTF-8" class="inoculation-form form-horizontal">
            {{ csrf_field() }}
                ...
                <div class="block-header block-header-default">
                    ...
                    <div class="btn-group btn-group-sm pull-right" role="group">
                        <div class="block-options pl-3 pr-2">
                            <button type="button" class="btn-block-option btn-preview" title="Preview">
                                <i class="si si-eye"></i>
                            </button>

                            <a href="{{ route('inoculations.index') }}" title="Show All Inoculation" class="btn-block-option">
        ...
        $(document).ready(function() {
            $('#checkedandok').change(function () {
                if ($(this).prop('checked')) {
                    $('#checkedandnotok').prop('checked', false);
                }
            });
            $('#checkedandnotok').change(function () {
                if ($(this).prop('checked')) {
                    $('#checkedandok').prop('checked', false);
                }
            });
        });
    </script>
