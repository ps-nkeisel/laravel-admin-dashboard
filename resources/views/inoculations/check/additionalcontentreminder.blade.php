    ...
    <div class="bg-body-light">
        <div class="content content-full">
            <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
                <h1 class="flex-sm-fill font-size-h2 font-w400 mt-2 mb-0 mb-sm-2">Check Inoculation additional contents remind date</h1>
                <nav class="flex-sm-00-auto ml-sm-3" aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item">Conditions</li>
                        <li class="breadcrumb-item active" aria-current="page">Inoculation</li>
                    </ol>
                </nav>
            </div>
        </div>
    ...
    <script>
        $(document).ready(function() {
            var contentadditionals_datatable = $('#contentadditionals_datatable').DataTable( {
                ...
                ordering: false,
                ajax: {
                    url: "{{ route('api.inoculations.check.reminder') }}",
                    type: "POST",
                    headers: {
                ...
                columns: [
                    ...
                    { data: 'id', width: "80px",
                        render: function(data, type, full, meta) {
                            return '<a href="{{ route("inoculations.index")}}/' + full.contentadditionalable_id + '" class="btn btn-sm btn-primary" title="Show Inoculation"><i class="si si-doc"></i></a>';
                        }
                    },
                ],
            });
