    ...
    <div class="bg-body-light">
        <div class="content content-full">
            <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
                <h1 class="flex-sm-fill font-size-h2 font-w400 mt-2 mb-0 mb-sm-2">Check health recommendation to countries</h1>
    ...
    <div class="content content-full">
        <div class="block block-rounded block-bordered dynamic_container">
            <div class="block-header block-header-default">
                <h3 class="block-title">List of unassigned countries</h3>
            ...
            <div class="block-content block-content-full">
                <table id="countries_datatable" class="table table-bordered table-striped table-vcenter">
                    ...
                    <tbody>
                    @foreach($unassigned_countries as $country)
                        <tr>
                            <td>{{ $country->id }}</td>
                            <td>{{ $country->code }}</td>
