...
@section('content')
    ...
    <div class="bg-body-light">
        <div class="content content-full">
            <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
                <h1 class="flex-sm-fill font-size-h2 font-w400 mt-2 mb-0 mb-sm-2">Edit Standard Content</h1>
    ...
    <!-- card -->
    <div class="content content-full">
        @if($content->archive == 1)
            <div class="alert alert-danger" role="alert">
                <p class="mb-0">You are not allowed to edit an archived version!</p>
            </div>
        @else
        <form method="POST" action="{{ route('contents.update', $content->id) }}" id="edit_content_form" name="edit_content_form" accept-charset="UTF-8" class="form-horizontal">
            {{ csrf_field() }}
                ...
                <div class="block-header block-header-default">
                    ...
                    <div class="btn-group btn-group-sm pull-right" role="group">
                        <div class="block-options pl-3 pr-2">
                            <a href="{{ route('contents.index') }}" title="Show All Content" class="btn-block-option">
