<div class="form-group row {{ $errors->has('content_en') ? 'is-invalid' : '' }}">
    ...
    <div class="col-md-10">
        <input class="form-control" name="content_en" type="text" id="content_en" value="{{ old('content_en', optional($adrheadkind)->content_en) }}" maxlength="45" placeholder="Enter content here...">
...
<div class="form-group row {{ $errors->has('content_de') ? 'is-invalid' : '' }}">
    ...
    <div class="col-md-10">
        <input class="form-control" name="content_de" type="text" id="content_de" value="{{ old('content_de', optional($adrheadkind)->content_de) }}" maxlength="45" placeholder="Enter content here...">
    ...
    <div class="col-md-10">
        <div class="custom-control custom-switch custom-control-primary custom-control-lg mb-2">
            <input type="checkbox" class="custom-control-input"
                id="active" name="active" {{ old('active', optional($adrheadkind)->active) == 1 ? 'checked' : '' }}/>
