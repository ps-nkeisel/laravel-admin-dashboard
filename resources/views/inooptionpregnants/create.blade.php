...
@section('content')
    ...
    <!-- card -->
    <div class="content content-full">
        <form method="POST" action="{{ route('inooptionpregnants.store') }}" accept-charset="UTF-8" id="create_inooptionpregnant_form" name="create_inooptionpregnant_form" class="form-horizontal">
            {{ csrf_field() }}
                ...
                <div class="block-header block-header-default">
                    ...
                    <div class="btn-group btn-group-sm pull-right" role="group">
                        <div class="block-options pl-3 pr-2">
                            <a href="{{ route('inooptionpregnants.index') }}" class="btn-block-option">
