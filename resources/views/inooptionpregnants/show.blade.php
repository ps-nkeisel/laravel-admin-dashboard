    ...
    <div class="bg-body-light">
        <div class="content content-full">
            <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
                <h1 class="flex-sm-fill font-size-h2 font-w400 mt-2 mb-0 mb-sm-2">Immunisation options pregnants details</h1>
            ...
            <div class="block-header block-header-default">
                ...
                <div class="btn-group btn-group-sm pull-right" role="group">
                    <div class="block-options pl-3 pr-2">
                        <a href="{{ route('inooptionpregnants.index') }}" class="btn-block-option" title="Show All Inooptionpregnant">
                            <i class="si si-list"></i>
                        </a>

                        <a href="{{ route('inooptionpregnants.edit', $inooptionpregnant->id ) }}" class="btn-block-option" title="Edit Inooptionpregnant">
                ...
                <div class="card-body">
                    <div class="row mb-3">
                        <div class="col-sm-5 col-md-6">
                            <dt>Position</dt>
                            <dd>{{ $inooptionpregnant->position }}</dd>
                        </div>
                    </div>
                    <div class="row mb-3">
                        <div class="col-sm-10 col-md-12">
                            <dt style="margin-top:15px;">Content</dt>
                            <dd>{{ $inooptionpregnant->content }}</dd>
                        </div>
                    </div>
                    <div class="row mb-3">
                        <div class="col-sm-10 col-md-12">
                            <dt style="margin-top:15px;">Content Code</dt>
                            <dd>{!! $inooptionpregnant->contentcode !!}</dd>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-10 col-md-12">
