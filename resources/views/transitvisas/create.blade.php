...
@section('content')
    ...
    <div class="bg-body-light">
        <div class="content content-full">
            <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
                <h1 class="flex-sm-fill font-size-h2 font-w400 mt-2 mb-0 mb-sm-2">Transitvisa create</h1>
    ...
    <!-- card -->
    <div class="content content-full">
        <form method="POST" action="{{ route('transitvisas.store') }}" accept-charset="UTF-8" id="create_transitvisa_form" name="create_transitvisa_form" class="transitvisa-form form-horizontal">
            {{ csrf_field() }}
