...
@section('content')
    ...
    <div class="bg-body-light">
        <div class="content content-full">
            <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
                <h1 class="flex-sm-fill font-size-h2 font-w400 mt-2 mb-0 mb-sm-2">Transitvisa</h1>
    ...
    <div class="content">
        <div class="block block-rounded block-bordered">
            ...
            <div class="block-content">
                <form method="POST" enctype="multipart/form-data" id="form_transitvisa_search">
                    <div class="row">
                        <div class="col-6">
    ...
    <div class="content content-full">
        ...
        <div class="block block-rounded block-bordered dynamic_container">
            <div class="block-header block-header-default">
                ...
                <div class="btn-group btn-group-sm pull-right" role="group">
                    <div class="block-options pl-3 pr-2">
                        <a href="{{ route('transitvisas.create') }}" class="btn-block-option" title="Create New Transitvisa">
            ...
            <div class="block-content block-content-full">
                ...
                <table id="transitvisas_datatable" class="table table-bordered table-striped table-vcenter">
                    <thead>
                        <tr>
                            <th>ID</th>
                            <th>Destination</th>
    ...
    <div class="content">
        <div class="block block-rounded block-bordered">
            ...
            <div class="block-content">
                <form method="POST" enctype="multipart/form-data" id="form_transitvisa_check">
                    <div class="row">
                        <div class="col-6">
                            <div class="form-group">
                                <div class="row">
...
@section('js_after')
    ...
    <script>
        $(document).ready(function() {
            var transitvisas_datatable = $('#transitvisas_datatable').DataTable( {
                serverSide: true,
                processing: true,
                searching: false,
                ajax: {
                    url: "{{ route('api.transitvisas.search') }}",
                    type: "POST",
                    headers: {
                    ...
                    data: function ( d ) {
                        ...
                        var formData = $('#form_transitvisa_search').serializeArray();
                ...
                columns: [
                    { data: 'id', className: "text-center", width: "80px",
                        render: function(data, type, full, meta) {
                            return '<a href="{{ route("transitvisas.index")}}/' + data + '">' + data + '</a>';
                        }
                    },
                    ...
                    { data: 'id', className: "text-right", width: "15%", orderable: false,
                        render: function(data, type, full, meta) {
                            return '<a href="{{ route("transitvisas.index")}}/' + data + '/edit" class="btn btn-sm btn-info mr-1" title="Edit Transitvisa"><i class="si si-pencil"></i></a>' +
                                '<a href="{{ route("transitvisas.index")}}/' + data + '" class="btn btn-sm btn-primary" title="Show Transitvisa"><i class="si si-doc"></i></a>';
                        }
                    },
                ],
            });

            $('#form_transitvisa_search').submit(function() {
                transitvisas_datatable.ajax.reload();
                return false;
            });
            $('#form_transitvisa_search').on('reset', function () {
            ...
            $('#start_check').click(function(event) {
                ...
                if ($('#check').prop('checked') == true) {
                    ...
                    window.location.href = '/transitvisas/check/natassign/' + checkcountrytocode;
                } else if ($('#checkall').prop('checked') == true) {
                    window.location.href = "{{ route('transitvisas.check.assign') }}";
                }
            });
        })
    </script>
