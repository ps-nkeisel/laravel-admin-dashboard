<!-- TransitvisaReport Modal Start -->

    <div class="modal fade" id="modalTransitvisaReport" tabindex="-1" role="dialog" aria-labelledby="modalTransitvisaReport">
...
<script>
    $(document).ready(function() {
        ...
        $('#modalTransitvisaReport').on('show.bs.modal', function (e) {
            var modal = $(this);
            ...
            $.ajax({
                type: 'POST',
                url: '{{ route("api.transitvisas.report") }}',
                data: {
                    id: "{{ $transitvisa->id }}",
                    lang,
                }
        ...
        $('.btn-create-pdf').click(function() {
            window.open('{{ route("transitvisas.report", $transitvisa->id) }}' + '?lang=' + lang);
        })
    })
</script>
