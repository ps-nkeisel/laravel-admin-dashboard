    ...
    <div class="bg-body-light">
        <div class="content content-full">
            <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
                <h1 class="flex-sm-fill font-size-h2 font-w400 mt-2 mb-0 mb-sm-2">Check Entry additional contents remind date</h1>
    ...
    <script>
        $(document).ready(function() {
            var contentadditionals_datatable = $('#contentadditionals_datatable').DataTable( {
                ...
                ordering: false,
                ajax: {
                    url: "{{ route('api.entries.check.reminder') }}",
                    type: "POST",
                    headers: {
                ...
                columns: [
                    ...
                    { data: 'id', width: "80px",
                        render: function(data, type, full, meta) {
                            return '<a href="{{ route("entries.index")}}/' + full.contentadditionalable_id + '" class="btn btn-sm btn-primary" title="Show Entry"><i class="si si-doc"></i></a>';
                        }
                    },
                ],
            });
