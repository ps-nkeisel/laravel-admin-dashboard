    ...
    <div class="bg-body-light">
        <div class="content content-full">
            <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
                <h1 class="flex-sm-fill font-size-h2 font-w400 mt-2 mb-0 mb-sm-2">Entries No Infos available</h1>
                <nav class="flex-sm-00-auto ml-sm-3" aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item">Conditions</li>
                        <li class="breadcrumb-item active" aria-current="page">Entry no info available</li>
                    </ol>
                </nav>
            </div>
        </div>
    ...
    <script>
        $(document).ready(function() {
            var entries_datatable = $('#entries_datatable').DataTable( {
                ...
                searching: true,
                ajax: {
                    url: "{{ route('api.entries.check.noinfos') }}",
                    type: "POST",
                    headers: {
