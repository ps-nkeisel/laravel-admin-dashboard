...
@section('content')
    ...
    <!-- card -->
    <div class="content content-full">
        <form method="POST" action="{{ route('infosystems.update', $infosystem->id) }}" accept-charset="UTF-8" id="edit_infosystem_form" name="edit_infosystem_form" accept-charset="UTF-8" class="form-horizontal">
            {{ csrf_field() }}
