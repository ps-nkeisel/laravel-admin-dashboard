...
class CreateEntryidentitydocumentsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('entryidentitydocuments', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('entryidentitydocuments');
    }
}
