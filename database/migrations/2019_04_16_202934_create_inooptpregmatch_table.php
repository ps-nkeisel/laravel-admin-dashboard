...
class CreateInooptpregmatchTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('inooptpregmatch', function (Blueprint $table) {
            $table->bigIncrements('id');
            $table->unsignedInteger('version')->nullable()->default(0)->index();
            $table->unsignedInteger('inoculation_id')->nullable()->default(0)->index();
            $table->unsignedInteger('inooptionpregnant_id')->nullable()->default(0)->index();
    ...
    {
        Schema::dropIfExists('inooptpregmatch');
    }
}
