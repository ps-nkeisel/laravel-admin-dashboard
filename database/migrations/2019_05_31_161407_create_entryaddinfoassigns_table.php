...
class CreateEntryaddinfoassignsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('entryaddinfoassigns', function (Blueprint $table) {
            $table->bigIncrements('id');
            $table->unsignedInteger('entry_id')->nullable()->default(0)->index();
            $table->unsignedInteger('entryaddinfo_id')->nullable()->default(0)->index();
    ...
    {
        Schema::dropIfExists('entryaddinfoassigns');
    }
}
